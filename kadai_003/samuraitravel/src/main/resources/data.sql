...
INSERT IGNORE INTO reviews (id, user_id, house_id, rating, comment) VALUES (1, 1, 1, 4, '立地が良くて広々とした部屋です。');
INSERT IGNORE INTO reviews (id, user_id, house_id, rating, comment) VALUES (2, 2, 1, 5, '素晴らしいサービスと設備が整っています。');
INSERT IGNORE INTO reviews (id, user_id, house_id, rating, comment) VALUES (3, 3, 1, 3, '場所はまあまあですが、周囲がうるさいです。');
INSERT IGNORE INTO reviews (id, user_id, house_id, rating, comment) VALUES (4, 4, 1, 4, '居心地が良くてスタッフもフレンドリーです。');
INSERT IGNORE INTO reviews (id, user_id, house_id, rating, comment) VALUES (5, 5, 1, 2, '清潔さとサービスにがっかりしました。');
INSERT IGNORE INTO reviews (id, user_id, house_id, rating, comment) VALUES (6, 6, 1, 5, '家族旅行に最適な宿です。');
INSERT IGNORE INTO reviews (id, user_id, house_id, rating, comment) VALUES (7, 7, 1, 4, 'バルコニーからの景色が素晴らしいです。');
INSERT IGNORE INTO reviews (id, user_id, house_id, rating, comment) VALUES (8, 8, 1, 3, '全体的には普通の体験でした。');
INSERT IGNORE INTO reviews (id, user_id, house_id, rating, comment) VALUES (9, 9, 1, 5, '滞在が最高でした！強くお勧めします。');
INSERT IGNORE INTO reviews (id, user_id, house_id, rating, comment) VALUES (10, 10, 1, 2, 'メンテナンスの問題があるためお勧めしません。');
INSERT IGNORE INTO reviews (id, user_id, house_id, rating, comment) VALUES (11, 11, 1, 4, '快適なベッドと清潔なバスルームです。');
